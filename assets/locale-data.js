  ...
  window.BRAWLZERK_PRESSKIT_TRANSLATIONS = {
        ko: {
          ...
          features: [
            {
              label: "직접 조작하는 공격",
              title: "기다리지 않고 직접 때린다",
              summary: "강·약 기본 공격과 전투 스킬을 직접 이어 붙여 적 무리의 흐름을 끊습니다. 자동 쿨타임만 기다리는 대신 거리와 적 상태에 맞는 기술을 선택합니다.",
              bullets: ["강·약 기본 공격과 지상 연계", "돌진·띄우기·추격·범위 기술", "상황에 따라 달라지는 직접 입력"],
            ...
            {
              label: "능동 방어",
              title: "막고 피한 순간, 반격이 시작된다",
              summary: "일반 가드로 압박을 버티고, 정확한 타이밍의 퍼펙트 가드와 저스트 회피로 짧은 반격 기회를 만듭니다. 성공 뒤에는 플레이어가 직접 리버설을 선택합니다.",
              bullets: ["가드와 퍼펙트 가드", "구르기와 저스트 회피", "성공 확인 뒤 직접 입력하는 리버설"],
              gifTitle: "가드·회피·리버설 영상 들어갈 자리",
              gifGuide: "실제 영상: 저스트 회피와 카운터 → 리버설로 흐름 전환",
              gifAria: "가드와 회피, 리버설을 보여주는 게임플레이 영상"
            },
            {
              label: "공중·벽 콤보",
            ...
            {
              label: "액티브 카드 & 패시브",
              title: "카드로 전황을 바꾸고, 패시브로 빌드를 완성한다",
              summary: "전투 중 직접 사용하는 액티브 스킬 카드와 런 전체를 강화하는 패시브 보상을 조합합니다. 다수 베기, 휠윈드, 빙결과 방어·기동 강화가 매 런 다른 전투 스타일을 만듭니다.",
              bullets: ["손패에서 고르고 직접 사용하는 액티브 카드", "공격·제어·방어·버프 전술", "런마다 달라지는 패시브 조합"],
          ...
          facts: {
            ...
            rows: [
              ...
              { label: "런 성장", value: "레벨업 · 패시브 보상 · 액티브 카드 덱 · 영구 업그레이드와 해금" },
    ...
    ko: {
      ...
      features: [
        ...
        },
        {
          ...
          label: "액티브 스킬 카드",
          title: "전투의 흐름을 바꾸세요",
          summary: "BRAWLZERK에서는 패시브 보상뿐만 아니라, 전투 중 직접 사용하는 액티브 스킬 카드도 획득할 수 있습니다. 여러 명의 적을 한꺼번에 베어내기, 휠윈드, 얼려서 묶어두기 등 다양한 방식으로 전투의 흐름을 바꿀 수 있습니다.",
          video: "BRAWLZERK_About_04_New.webm",
          poster: "BRAWLZERK_Screenshot_02.png",
